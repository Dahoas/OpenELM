...
""",
    ...
    "MiniGrid-Dynamic-Obstacles-8x8-v0": dict(
        task_description="""\
This environment is an empty room with moving obstacle balls. The goal of the agent is to reach the green goal square \
without colliding with any obstacle. A large penalty is subtracted if the agent collides with an obstacle and the \
episode finishes.
""",
        observation_description="""\
You can see a (7, 7) square of tiles in the direction you are facing and your inventory of item. \
Formally \
